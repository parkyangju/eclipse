...
<html lang="kr"> 
    ...
    <body>
        <!-- page start -->
		<div id="main" data-role="page" class="type-index">
			...
			<!-- footer end --> 
			<a href="#view"data-role="button">내부링크</a>
			<a href="http://localhost:8080/guide/api/events.do" data-role="button">외부링크</a>
      
         </div>
         
          <div id="view" data-role="page" class="type-index">
          	<p> 상세보기 페이지 </p>
			<a href="#main"data-role="button">메인페이지로 이동</a>
          </div>
     </body>
 </html>